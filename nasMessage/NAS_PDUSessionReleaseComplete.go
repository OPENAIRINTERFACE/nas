...
func (a *PDUSessionReleaseComplete) EncodePDUSessionReleaseComplete(
	buffer *bytes.Buffer,
) {
	binary.Write(
		buffer,
	...
	binary.Write(
		buffer,
		binary.BigEndian,
		&a.PDUSESSIONRELEASECOMPLETEMessageIdentity.Octet,
	)
	if a.Cause5GSM != nil {
...
func (a *PDUSessionReleaseComplete) DecodePDUSessionReleaseComplete(
	byteArray *[]byte,
) {
