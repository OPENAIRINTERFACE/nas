...
func (a *PDUSessionReleaseCommand) EncodePDUSessionReleaseCommand(
	buffer *bytes.Buffer,
) {
	binary.Write(
		buffer,
	...
	binary.Write(
		buffer,
		binary.BigEndian,
		&a.PDUSESSIONRELEASECOMMANDMessageIdentity.Octet,
	)
...
func (a *PDUSessionReleaseCommand) DecodePDUSessionReleaseCommand(
	byteArray *[]byte,
) {
