...
func (a *PDUSessionAuthenticationCommand) EncodePDUSessionAuthenticationCommand(
	buffer *bytes.Buffer,
) {
	binary.Write(
		buffer,
	...
	binary.Write(
		buffer,
		binary.BigEndian,
		&a.PDUSESSIONAUTHENTICATIONCOMMANDMessageIdentity.Octet,
	)
...
func (a *PDUSessionAuthenticationCommand) DecodePDUSessionAuthenticationCommand(
	byteArray *[]byte,
) {
