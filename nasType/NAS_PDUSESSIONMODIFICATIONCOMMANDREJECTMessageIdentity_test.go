...
func TestNasTypeNewPDUSESSIONMODIFICATIONCOMMANDREJECTMessageIdentity(
	t *testing.T,
) {
...
func TestNasTypeGetSetPDUSESSIONMODIFICATIONCOMMANDREJECTMessageIdentityMessageType(
	t *testing.T,
) {
	a := nasType.NewPDUSESSIONMODIFICATIONCOMMANDREJECTMessageIdentity()
